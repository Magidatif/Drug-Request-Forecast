                ...
                <div class="bg-white dark:bg-darkcard rounded-3xl p-6 shadow-sm dark:shadow-2xl border border-slate-200/80 dark:border-slate-700/80 transition-colors">
                    <div class="flex items-center gap-2 mb-5 pb-3 border-b border-slate-100 dark:border-slate-700/60">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <div class="flex justify-between items-center mb-1.5">
                                    <label id="i18n-labelDrug" class="block text-xs font-bold text-slate-700 dark:text-slate-300">اسم الصنف</label>
                                    <span class="text-[10px] font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950 px-1.5 py-0.2 rounded border border-emerald-200 dark:border-emerald-800">English Only</span>
                                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-1.5">
                                    <label id="i18n-labelSafety" class="block text-xs font-bold text-slate-700 dark:text-slate-300">كفاية رصيد الأمان (بالأيام)</label>
                                    <span id="i18n-autoSafetyBadge" class="text-[10px] font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950 px-1.5 py-0.2 rounded border border-emerald-200 dark:border-emerald-800">تلقائي (50% توريد)</span>
                                </div>
