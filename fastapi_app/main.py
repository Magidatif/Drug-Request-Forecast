        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="bg-white dark:bg-darkcard p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-sm stat-card">
                        <div id="i18n-kpiDbStatus" class="text-slate-400 dark:text-slate-400 text-xs font-bold mb-1">حالة النظام الذكي</div>
                        <div class="text-xs font-bold text-emerald-700 dark:text-emerald-400 flex items-center gap-1.5 mt-2">
                            <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> <span id="i18n-dbOnline">جاهز للعمل • Active</span>
                        </div>
                    </div>
                </div>
