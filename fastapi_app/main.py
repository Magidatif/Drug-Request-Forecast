...
<body class="min-h-screen bg-slate-50 dark:bg-darkbg text-slate-800 dark:text-slate-100 flex flex-col antialiased">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-6">
                <div class="bg-white dark:bg-darkcard rounded-3xl p-6 shadow-sm dark:shadow-2xl border border-slate-200/80 dark:border-slate-700/80 transition-colors">
                    ...
                    <form id="forecastForm" onsubmit="handleCalculate(event)" novalidate class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="facilityName" placeholder=""
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="drugName" placeholder="e.g. Paracetamol 500mg" dir="ltr"
                            ...
                            <div>
                                ...
                                <input type="number" step="any" min="0" id="m1Consumption" required placeholder="" oninput="liveUpdateCalculation()"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="any" min="0" id="m2Consumption" required placeholder="" oninput="liveUpdateCalculation()"
                                    class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-darkinput border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-white transition outline-none font-semibold">
                            </div>

                            <div>
                                <label id="i18n-labelM3" class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">استهلاك الشهر الثالث</label>
                                <input type="number" step="any" min="0" id="m3Consumption" required placeholder="" oninput="liveUpdateCalculation()"
                                    class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-darkinput border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-white transition outline-none font-semibold">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="1" min="0" id="leadDays" oninput="onLeadDaysChange()" placeholder=""
                                    class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-darkinput border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-white transition outline-none font-semibold">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="1" min="0" id="safetyDays" oninput="liveUpdateCalculation()" placeholder=""
                                    class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-darkinput border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-white transition outline-none font-semibold">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="any" min="0" id="currentStock" placeholder="" oninput="liveUpdateCalculation()"
                                    class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-darkinput border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-slate-900 text-slate-900 dark:text-white transition outline-none font-semibold">
                            </div>
    ...
    <script>
        ...
        function onLeadDaysChange() {
            const leadInput = document.getElementById('leadDays').value;
            if (leadInput === '') {
                document.getElementById('safetyDays').value = '';
            } else {
                const lead = parseFloat(leadInput) || 0;
        ...
        function handleCalculate(e) {
            ...
            let drug = document.getElementById('drugName').value.trim();
            const m1 = parseFloat(document.getElementById('m1Consumption').value) || 0;
            const m2 = parseFloat(document.getElementById('m2Consumption').value) || 0;
            const m3 = parseFloat(document.getElementById('m3Consumption').value) || 0;
            const leadDays = parseFloat(document.getElementById('leadDays').value) || 0;
            ...
            // If empty, set friendly default
            if (!drug) {
                drug = currentLang === 'ar' ? 'صنف غير محدد' : 'General Drug Item';
            }
