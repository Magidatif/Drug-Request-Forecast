# نظام التنبؤ باحتياجات الأدوية (Drug Request Forecast System)

نظام متكامل لتوقع واحتساب طلبيات الأدوية للمستشفيات ومراكز الرعاية الصحية الأولية مبني بلغة **Python** مع دعم النشر السحابي المباشر عبر **Cloudflare Workers** و **FastAPI**.
...
- 📊 **سجل تاريخي وتصدير:** استعراض كافة السجلات والبحث والتصفية مع إمكانية التصدير المباشر لملفات Excel / CSV.
...
```text
├── fastapi_app/
│   ├── main.py              # تطبيق FastAPI متكامل مع الواجهة وقاعدة البيانات
